...
>(
  ...
  const resolvedAccept = accept ?? draggableContext.defaultKind;
  ...
  (props: DropTargetRootPropsWithDefaultAccept): React.JSX.Element;
...
type DropTargetRootPropsWithDefaultAccept = Omit<
  DropTargetRootPropsBase<undefined, undefined>,
  'accept'
> &
