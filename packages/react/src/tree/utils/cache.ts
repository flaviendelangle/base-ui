...
export class DataSourceCacheDefault<TItem = any> implements DataSourceCache<TItem> {
  private cache: Record<CollectionItemId, { value: TItem[]; expiry: number }>;
  ...
  set(key: CollectionItemId, value: TItem[]) {
